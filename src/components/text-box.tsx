...
const textSchema = z.object({
  text: z
    .string()
    .min(32, "Text must be at least 32 characters")
    ...
    <Card className="w-full shadow-lg">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardHeader className="pb-4">
            <div className="space-x-2">
              <Button type="button" className="text-xs h-8" variant="outline">
                ChatGPT
              </Button>
              <Button disabled className="text-xs h-8" variant="outline">
                Claude
              </Button>
              <Button disabled className="text-xs h-8" variant="outline">
                Llama
      ...
      {humanizedText && (
        <TextGeneratedBox
          ...
          humanizedTextRef={humanizedTextRef}
        />
      )}
    </Card>
  );
